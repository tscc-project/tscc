...
The primitive expression checkpoint contains 516 cases: 489 pass, zero fail, and 27
...
Five semantic-only cases are now active checker contracts: direct literal
...
operators, and lexical shadowing. Unsupported expression/type forms continue to skip rather than being
