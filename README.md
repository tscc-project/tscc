...
This is the beginning of type checking, not a general TypeScript type system. The checker owns primitive/literal/union/nullish facts, bounded expressions and assignments, ordinary-function signatures, and strict equality/`typeof` branch facts. Object types, inference, callable expressions, overloads, generics, general control-flow joins and definite assignment remain unchecked. The independent 525-case corpus records 499 passes, no failures, and 26 explicit semantic skips.
