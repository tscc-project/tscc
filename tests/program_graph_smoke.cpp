...
int main(){auto dir=fs::temp_directory_path()/"tscc-program-graph-smoke";fs::remove_all(dir);fs::create_directories(dir);write(dir/"a.ts","import {b} from './b.js'; export const a:number=b+1;");write(dir/"b.ts","import {a} from './a.js'; export const b:number=1;");
