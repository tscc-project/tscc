...
test-flow-narrowing: tscc
	bash tests/flow_narrowing.sh
test-richer-collections: tscc
	bash tests/richer_collections.sh
...
test: test-oracles test-preview-contract test-diagnostics test-project-output-contract test-product-boundary test-feature-matrix test-trial-blockers test-config test-smoke test-parser test-parser-recovery test-syntax-identity test-expression-ownership test-control-flow test-flow-narrowing test-richer-collections test-binder test-declaration-scope test-declaration-frontend test-standard-library test-generics test-generic-inference test-overloads test-classes test-class-relationships test-types test-edits test-checker test-compilation-unit test-program-graph test-runtime test-project test-regression test-tsx test-commonjs
