...
DEPFLAGS ?= -MMD -MP
CPPFLAGS ?= -Isrc
SOURCES := src/main.cpp src/tscc/Diagnostic.cpp src/tscc/Source.cpp src/tscc/Lexer.cpp src/tscc/Parser.cpp src/tscc/Semantic.cpp src/tscc/Binder.cpp src/tscc/Checker.cpp src/tscc/SourceEdit.cpp src/tscc/Transpiler.cpp src/tscc/Project.cpp src/tscc/Config.cpp src/tscc/Compiler.cpp
...
.PHONY: all test test-smoke test-parser test-binder test-edits test-checker test-runtime test-project test-regression test-tsx test-commonjs check-regression-sync clean
...
test: test-smoke test-parser test-binder test-edits test-checker test-runtime test-project test-regression test-tsx test-commonjs
